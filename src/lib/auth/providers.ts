 ...
 *
 * Each app federates to the shared **auth broker** (`HAMADINE_AUTH_ISSUER`), which
 ...
 * here (`{ providerId: "hamadine-github", idp: "github", label: "GitHub" }`). The
...
export const HAMADINE_PROVIDERS: readonly HamadineProvider[] = [
  { providerId: "hamadine-google", idp: "google", label: "Google" },
  { providerId: "hamadine-x", idp: "twitter", label: "X" },
];
